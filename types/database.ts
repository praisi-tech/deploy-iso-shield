...
// Ekspor tipe yang dibutuhkan oleh RiskBadge
export type RiskLevel = Enums<'risk_level'>
export type AssetCriticality = Enums<'asset_criticality'>
export type AssetType = Enums<'asset_type'>

// Opsional: Jika kamu butuh tipe untuk tabel tertentu
export type Profile = Tables<'profiles'>
export type Asset = Tables<'assets'>


// Ekspor tipe untuk Organization Actions
export type BusinessSector = Enums<'business_sector'>
export type ExposureLevel = Enums<'exposure_level'>

// Tambahkan juga tipe lain yang sering digunakan agar tidak error lagi nanti
export type UserRole = Enums<'user_role'>
export type FindingSeverity = Enums<'finding_severity'>
export type FindingStatus = Enums<'finding_status'>
export type ControlStatus = Enums<'control_status'>